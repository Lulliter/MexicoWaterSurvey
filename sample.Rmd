...
In this project, the classification that we use is mostly derived from a _Nota Tecnica_ prepared by some colleagues of the IADB, WSA division [See @riquelme_organismos_2018, pp. 1-3]. This managed to retreive some basic information on **2,252 Prestadores**. 
...
# # Then use view(), like so:
 view(Freq_Tipo, method = "pander", style = "rmarkdown", omit.headings = TRUE,
 	  	report.title = "Agencies Providing Water & Sanitation by Type (Including when Not properly defined"	)
# 
