...
INEGI has identified a total of _2,688  "Organismos Operadores"_ (OO) in the _"Censo de Captacion, Tratamiento y Suministro de Agua"_  conducted in 2014 and published in 2016 [ @inegi_panorama_2016 ].  Of all of these, some ~700 could be rightly defined as _"Organismos Operadores"_, i.e. entities specialized in the provision of the services of water and sanitation (regardless of their degree of autonomy in their decision making and financial management. 
	...
	>  The service providers *"organismo que presta el servicio de captaciòn, tratamiento y suministro de agua"* in Mexico are extremely heterogeneous in nature and conditions. Here are some key information from the Economic Census

+ JURIDICAL CATEGORY:
	* 2401 (of 2668) are _servicios del sector publico_
	* 257 (of 2668) are _asociaciòn civil_
...
+ EMPLOYED PERSONNEL:
	...
	* ~~personal no dependiente de la razòn social~~ 
...
+ DistribuciÃ³n porcentual de los ingresos según la venta de agua potable por tipo de usuario
	* Toma domestica 60.9 %
	* Toma comercial 25.3 %
	* Toma industrial 8.1 %
...
## Entidades and Municipios in Sample

>>>...... MUST REVISE....

```{r explan2, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
# The ENTIDADES and MUNICIPIOS INCLUDEDE in the LAPOP/POPA clusters (2016 --> closely followed in 2018)
